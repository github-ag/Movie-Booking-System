			...
			<div class="row">
				<div class="col-md-8">
					<form name="bookingForm" id="bookingForm" action="booksuccess.php"  method="post" novalidate>
						...
						<?php echo"<input type='hidden' name='MovieName' value='$MovieName'>";?>

						<div class="control-group form-group">
							<div class="controls">
								<label>Number of tickets:</label>
								<input type="number" min="1" max="10" class="form-control" id="ticket" value="1" name="num_tickets" required>
							</div>
						</div>
						<div id="visible">
						...
						<div id="invisible">
							...
							<br><br>
							<?php echo "<button type='submit' id='btnBook' class='btn btn-danger btn-block' >Book Tickets</button>";?>
